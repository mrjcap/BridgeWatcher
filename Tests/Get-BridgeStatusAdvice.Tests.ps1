...
Describe 'Get-BridgeStatusAdvice Tests' {
    ...
    It 'should return "Είναι προτιμότερο να μην περιμένεις" when minutes until open is negative' {
        $result = Get-BridgeStatusAdvice -MinutesUntilOpen -5
        $result | Should -Be 'Είναι προτιμότερο να μην περιμένεις'
    }
    It 'should return "Είναι προτιμότερο να μην περιμένεις" when minutes until open is zero' {
